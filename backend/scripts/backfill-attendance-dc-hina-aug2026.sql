...
DECLARE @EmpId        INT          = 14;
DECLARE @ExpectedName NVARCHAR(50) = N'%Hina%';
...
--    Spreadsheet "1:30" / "1:05" → 13:xx; "2:00" → 14:00.
----------------------------------------------------------------------------
...
VALUES
    ...
    ('2026-08-08', '08:00', '14:00'),
    ('2026-08-20', '08:20', '13:05');
