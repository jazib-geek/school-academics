...
DECLARE @EmpId        INT          = 5;
DECLARE @ExpectedName NVARCHAR(50) = N'%Faiza%';
...
--    Spreadsheet "1:00" / "1:30" → 13:xx; "2:00" → 14:00; "12,00" → 12:00.
----------------------------------------------------------------------------
...
VALUES
    ('2026-08-04', '09:30', '13:00'),
    ('2026-08-05', '08:30', '13:30'),
    ('2026-08-08', '08:15', '13:00'),
    ('2026-08-13', '08:00', '12:00'),
    ('2026-08-21', '08:00', '13:30'),
    ('2026-08-22', '07:50', '13:00'),
    ('2026-08-23', '07:25', '14:00');
