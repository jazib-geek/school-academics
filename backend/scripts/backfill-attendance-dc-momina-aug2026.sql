/*
  ...
  Teacher: Miss Momina / Momna (EmpID = 9)
...
DECLARE @EmpId        INT          = 9;
DECLARE @ExpectedName NVARCHAR(50) = N'%Mom%na%'; -- Momina / Momna
...
--    Spreadsheet "1:15"/"1:30"/"1:45" → 13:xx; "2:00" → 14:00; 11:30/12:xx stay as-is.
----------------------------------------------------------------------------
...
VALUES
    ('2026-08-03', '09:00', '11:30'),
    ('2026-08-04', '09:30', '14:00'),
    ('2026-08-05', '09:00', '13:15'),
    ('2026-08-10', '09:50', '12:15'),
    ('2026-08-15', '11:00', '13:45'),
    ('2026-08-20', '08:10', '13:30'),
    ('2026-08-21', '08:15', '12:30');
