...
{
    private readonly ISmartAttendanceReportService _smart;

    public AttendanceReportsController(ISmartAttendanceReportService smart)
    {
        _smart = smart;
    }
    ...
    [HttpPost("smart/run")]
    public async Task<IActionResult> RunSmartReport([FromBody] SmartAttendanceReportRunRequestDto? request)
    {
