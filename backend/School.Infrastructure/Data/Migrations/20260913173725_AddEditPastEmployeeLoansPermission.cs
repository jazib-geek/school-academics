...
{
    /// <inheritdoc />
    public partial class AddEditPastEmployeeLoansPermission : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                {
                    139,
                    "edit_past_employee_loans",
                    true,
                    "Employee",
                    "Edit Past Employee Salary Adjustments",
                    1390
                });
            ...
            migrationBuilder.Sql(
                ...
                WHERE p.Code IN (N'edit_past_employee_loans');
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                """
                DELETE FROM dbo.tblUserRights WHERE ModuleCode = N'edit_past_employee_loans';
                """);
